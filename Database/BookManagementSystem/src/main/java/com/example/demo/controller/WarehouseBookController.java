...
public class WarehouseBookController {
	...
	public String addBook(@RequestBody Book book)
	{
		...
		return MessageConstants.BOOK_ADDED_WAREHOUSE;
	}
	...
	public String deleteBook(@PathVariable int id)
	{
		...
		return MessageConstants.BOOK_DELETE_WAREHOUSE;
	}
	...
	public String deleteAllBooks(@RequestBody Book book)
	{
		...
		return MessageConstants.ALL_BOOKS_DELETED_WAREHOUSE;
	}
